...
public class Teste {
	...
	public static void main(String[] args) {
		...
		String[] opcoesConversaoReal = { "Real para Dólar", "Real para Euro", "Real para Libras", "Dólar para Real",
				"Euro para Real", "Libras para Real" };
		...
		while (true) {
			...
			if (nome == valores[0]) {
				...
				Object selecaoDeConversaoReal = JOptionPane.showInputDialog(null, "Converter Real para...",
						"Menu de Conversão", JOptionPane.DEFAULT_OPTION, null, opcoesConversaoReal,
						opcoesConversaoReal[0]);

				if (selecaoDeConversaoReal == null) {
